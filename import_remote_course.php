...
echo "(2) Generate or get last automated remote backup via Web Service...<br>";
...
//echo "Link to file:<br>";
//print_object($resp);
//die;

echo "(3) Starting download & redirecting to restore process...<br>";
...
echo "(4) Start quick restore into (merge) current course...<br>";
