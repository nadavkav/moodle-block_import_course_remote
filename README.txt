...
* Rename the import_remote_course/ folder to the name of your module (eg "widget").
...
all the instances of the string "import_remote_course" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/import_remote_course/widget/g' {} \;

* Rename the file lang/en/import_remote_course.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_import_remote_course.php
...
and you should find that this import_remote_course has been added to the list of
installed modules.
